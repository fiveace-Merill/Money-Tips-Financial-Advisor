...
export default function Layout({ children }: { children: React.ReactNode }) {
  return (
    <main className="relative h-screen max-h-screen flex flex-col items-stretch gap-3 lg:flex-row">
      ...
      <section className="w-full basis-11/12 p-2 flex-auto max-w-screen max-h-screen flex flex-col justify-between md:gap-6 lg:items-center lg:rounded-2xl lg:gap-3 lg:basis-9/12 lg:min-h-screen">
        <div className="basis-11/12 w-full h-full rounded-xl bg-background-container/20 border-2 border-background-container md:mx-auto md:w-10/12 lg:flex-1 lg:pt-3 lg:w-11/12 lg:rounded-2xl">
          {children}
        </div>
